<template>
    <div class="todo-list-container">
        ...
        <ul class="task-list">
            <li v-for="task of todoList":key="task.id" class="todo-item">
              <div class="todo-item-content" :style="{ 'text-decoration': task.isComplete ? 'line-through' : 'none' }">
                <p v-if="!task.isEdit" class="todo-item-text" >
                  {{ task.description }}
                </p>
                <input v-else class="edit-task" v-model="task.description" type="text"/>
                <div class="todo-item-actions">
                    <div v-if="!task.isEdit" class="edit-button" @click = "task.isEdit = !task.isEdit" >
                        <svg class="edit-icon" width="25" height="25" viewBox="0 0 25 25" fill="#404040" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div v-else class="save-button" @click = "task.isEdit = !task.isEdit">
                        <svg class="save-icon" width="26" height="26" viewBox="0 0 26 26" fill="#404040" xmlns="http://www.w3.org/2000/svg">
